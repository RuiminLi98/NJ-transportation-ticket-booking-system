		...
		<table>
			...
			<% while(rs.next()){%>
				<tr>
					...
					<td>
					<a href="Customer_representative_deleteRe.jsp?reservation=<%=ID%>">Cancel</a>
					</td>
