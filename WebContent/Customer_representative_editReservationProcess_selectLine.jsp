...
<%
	...
	boolean assist = !(ssn == -1);
		...
		if(newSeatNum < 0){
			...
			String deleteOld = "DELETE FROM TrainTicketing.Reservation WHERE reservation_number = " + Integer.toString(old_rsid) + ";";
			try{
				stmt.executeUpdate(deleteOld);
			}catch(Exception e){
				out.println("An unknown error occurred during deletion.");return;
			}
			stmt.close();
			con.close();
